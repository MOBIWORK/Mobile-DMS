...
export enum SLICE_NAME {
  ...
  ADDING_NEW_CUSTOMER = 'ADDING_NEW_CUSTOMER_',
  GET_CUSTOMER_TERRITORY = 'GET_CUSTOMER_TERRITORY_',
  NOTE_SLICE = 'NOTE_SLICE_',
  GET_LIST_MAIL = 'GET_LIST_MAIL_',
...
export const ADDING_NEW_CUSTOMER = SLICE_NAME.ADDING_NEW_CUSTOMER + 'ADDING_NEW_CUSTOMER'
export const GET_CUSTOMER_TERRITORY = SLICE_NAME.GET_CUSTOMER_TERRITORY + 'GET_CUSTOMER_TERRITORY'
export const GET_LIST_MAIL = SLICE_NAME.GET_LIST_MAIL + 'GET_LIST_MAIL'
export const GET_NOTE_TYPE = SLICE_NAME.GET_NOTE_TYPE + 'GET_NOTE_TYPE'
export const GET_LIST_STAFF = SLICE_NAME.GET_LIST_STAFF + 'GET_LIST_STAFF_'
export const GET_CUSTOMER_PAGE =SLICE_NAME.GET_CUSTOMER_PAGE + 'GET_CUSTOMER_PAGE'
