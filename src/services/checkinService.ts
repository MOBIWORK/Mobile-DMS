...
export const checkinInventory = (data: POST_DATA) =>
  createApi().post(ApiConstant.POST_CHECKIN_INVENTORY, data);
...
export const getNoteCheckin = (params: {custom_checkin_id: string}) =>
  createApi().get(ApiConstant.GET_LIST_NOTE_API, params);
