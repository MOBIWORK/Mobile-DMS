export default {
  ...
  haveToPay: 'Phải thanh toán',
  billCount: 'Số đơn',
  report: 'Báo cáo',
  visitDetail: 'Chi tiết viếng thăm',
  lastOrder: 'Đơn hàng lần cuối',
  lastVisit: 'Viếng thăm lần cuối',
  day: 'Ngày',
  totalDebt: 'Tổng tiền nợ',
  promotionalProducts: 'Sản phẩm KM',
  listOrder: 'Danh sách đơn',
  openDoor: 'Mở cửa',
  closeDoor: 'Đóng cửa',
  outVisitMsg: 'Bạn muốn thoát viếng thăm ?',
  ...
  chooseBirthday: 'Chọn ngày sinh nhật',
  chooseImage: 'Chọn ảnh',
  takePicture: 'Chụp ảnh',
  chooseFromLibrary: 'Chọn từ thư viện',
  pSearchCustomer: 'Tìm kiếm khách hàng...',
  ...
  darkMode: 'Chế độ tối',
  reachPercent: 'Đạt {percent}%',
  totalSalesPerMouth: 'Tổng doanh số tháng đến thời điểm hiện tại',
  totalRevenuePerMouth: 'Tổng doanh thu tháng đến thời điểm hiện tại',
  noShirtNow: 'Hiện tại bạn không có ca làm',
  noVisit: 'Chưa có viếng thăm',
  loginToBiometric: 'Đăng nhập bằng {biometric}',
  changePassword: 'Đặt lại mật khẩu',
  notifySetting: 'Cài đặt thông báo',
  enterPassword: 'Nhập mật khẩu hiện tại',
  confirm: 'Xác nhận',
  notifySecurity: 'Thông báo bảo mật',
  notifyAbnormal: 'Cảnh báo bất thường',
  notifyOtherLogin: 'Thông báo khi có thiết bị lạ đăng nhập',
