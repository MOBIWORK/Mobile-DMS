...
export const SalesItem: ItemProps[] = [
  ...
  },
  {
    ...
    icon: 'ReportKPI',
    onPress: () => navigate(ScreenConstant.REPORT_KPI),
  },
  {
    title: 'Khách hàng mới',
    content: 'Các khách hàng được tạo mới',
    icon: 'NewCustomerIcon',
    onPress: () => navigate(ScreenConstant.NEW_CUSTOMER),
  },
  {
