            ...
            <View
                ...
                <View style={{ marginTop: 32, rowGap: 24 }}>
                    ...
                    <AppInput
                        ...
                        value={
                            productSelect?.amount
                                ? CommonUtils.formatCash(productSelect.amount.toString())
                                : ''
                        }
                        editable={false}
                        styles={{
                    ...
                    <AppInput
                        ...
                        rightIcon={<TextInput.Affix text="%" textStyle={{ fontSize: 20 }} />}
                    />
                    <AppInput
                        label={getLabel('discount')}
                ...
                <View style={[styles.footerBttSheet, { bottom: bottom }]}>
                    <AppButton
            ...
            <MainLayout style={styles.layout}>
                    ...
                    <View style={{ paddingHorizontal: 16, rowGap: 24, marginTop: 10 }}>
                        <View>
                            ...
                            <View
                                ...
                                <Text style={[styles.inforCustomer]}>
                ...
                <View style={styles.footerDetail}>
                    <View
                        style={[
                            styles.flexSpace,
                            { alignItems: 'center', paddingHorizontal: 16, paddingBottom: 30 },
                        ]}>
