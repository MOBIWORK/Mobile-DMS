...
const ItemProduct = ({name,dvt,quantity,price,percentage_discount,discount}: ProductProps) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.flexSpace}>
                <Text style={styles.textIf(colors.text_primary)}>Thành tiền</Text>
                <Text style={styles.name}>7.000.000</Text>
            </View>
        </View>
    )
}
