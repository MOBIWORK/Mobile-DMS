...
const Inventory: FC<InventoryProps> = ({inventoryData}) => {
  ...
  const ProductItem = React.useCallback(
    (productItem: ReportProductInventoryType) => {
      return (
  ...
  const InventoryItem = React.useCallback(
    (inventoryItem: ReportInventoryType) => {
      return (
        <Accordion
          type="regular"
  ...
  return (
    <FlatList
      ...
      contentContainerStyle={{marginBottom: bottom, marginTop: 16}}
